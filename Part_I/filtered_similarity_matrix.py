...
# File paths 
blast_file = "blastp_filtered.tsv"
output_similarity = "protein_similarity_matrix_filtered.csv"
output_distance = "protein_distance_matrix_filtered.csv"
output_tree = "protein_phylogenetic_tree_filtered.nwk"
...
# Build tree (Neighbor-Joining) - mgiht require running in a conda environment
lower_triangular = []
