...
input_file = "validated_hits_v2.xlsx"
sheet_name = "Sheet1"
...
plt.title('Validated Probe Hits in AD SRA samples', fontsize=22, fontweight='bold')
...
# Plot
plt.tight_layout()
plt.savefig('AD_heatmap_validated_v5.png', dpi=300, bbox_inches='tight')
plt.show()
